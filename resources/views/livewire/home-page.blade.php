            ...
            @if($courses->count() > 0)
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach ($courses as $course)
                        <div
                            class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
                ...
                <div class="text-center mt-12">
                    <a href="/courses"
                        class="inline-block px-8 py-4 bg-primary hover:bg-primary-hover text-white rounded-lg font-semibold text-lg transition-colors">
                        Lihat Semua Kursus
                    </a>
                </div>
            @else
                ...
                <div class="flex flex-col items-center justify-center py-16 px-4">
                    <div class="w-32 h-32 bg-gradient-to-br from-primary/10 to-primary/5 rounded-full flex items-center justify-center mb-6">
                        <i data-lucide="book-open" class="h-16 w-16 text-primary"></i>
                    </div>
                    <h3 class="text-3xl font-bold text-gray-900 mb-3">Belum Ada Kursus Tersedia</h3>
                    <p class="text-gray-600 text-center max-w-md mb-8 text-lg">
                        Saat ini kami sedang mempersiapkan kursus-kursus berkualitas untuk Anda. Nantikan segera!
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4">
                        <a href="#"
                        ...
                        <button
                            class="px-6 py-3 border-2 border-gray-300 text-gray-900 hover:border-primary hover:text-primary rounded-lg font-medium transition-colors">
                            Beritahu Saya
                        </button>
                    </div>
                </div>
